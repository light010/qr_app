...
- MUST follow exact order: assemble → decompress → decrypt → validate
...
**If any of these occur → STOP. Review generator specification FIRST.**
...
**Breaking this coupling → System failure in field.**
