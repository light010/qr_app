...
- ✅ **Compression**: Brotli level 11 (ONLY algorithm - best compression ratio, native browser support)
...
# With compression (Brotli-11 is always used - highest quality)
python -m src.main generate /path/to/file.txt --compression brotli
...
# Generate QR codes
generate <file_path>
    --compression brotli              # Compression (always Brotli-11)
...
2. **Compression**: Brotli-11 offers BEST compression ratio + native browser support
